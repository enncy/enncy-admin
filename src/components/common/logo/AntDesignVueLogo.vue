<template>
  ...
  <div style="overflow: hidden;">
    <a-row class="d-flex  flex-align-center " >
      <a-col>
        <!--ant design vue 的 logo-->
        <slot name="logo">
          <img alt="logo" height="32" width="80"
      ...
      <!--项目名-->
      <a-col style="min-width: 200px" class="d-flex" >
        <div class="color-white flex-left  d-flex-center-align flex-nowrap" style="font-weight: bold;font-size: 20px; "
             :style="{color:getTextColor}">{{ title }}
        </div>
      </a-col>
    </a-row>
  </div>
